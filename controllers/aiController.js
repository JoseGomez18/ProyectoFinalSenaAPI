...
// const consults = require('../models/consults.js');
...
// Usa una función asíncrona para inicializar el agente
...
// Inicializa el agente y exporta los controladores
let agentExecutor;
...
exports.infoDestino = async (req, res) => {
    try {
        const ids = req.body.id;
        const idList = Array.isArray(ids) ? ids.join(',') : ids;
